...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Void> {
        ...
        // TODO: attempt authentication against a network service.
            ...
            String jSessionId = CKApplication.getInstance().getJSessionID();
            service.credentialsCheck(jSessionId, mEmail, mPassword, new Callback<JsonObject>() {
                @Override
                public void success(JsonObject jsonObject, Response response) {
                    ...
                    boolean loginCompleted = state.equals("COMPLETED");
                    if (state.equals("COMPLETED")) {
                        ...
                        mainactivity.putExtra("showPath", true);
    ...
    public void loginCompleted(final boolean success) {
        mAuthTask = null;
        showProgress(false);
